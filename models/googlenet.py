...
def googlenet(pretrained=False, progress=True, device="cpu", path="", **kwargs):
    ...
    if pretrained:
        ...
        state_dict = torch.load(
            path + "/CIFAR10/custom/googlenet.pt", map_location=device
        )
        print('Loading MobileNetv2 from', path + "/CIFAR10/custom/googlenet.pt")
