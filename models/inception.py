...
def inception_v3(pretrained=False, progress=True, device="cpu", path="", **kwargs):
    ...
    if pretrained:
        ...
        state_dict = torch.load(
            path + "/CIFAR10/custom/inception_v3.pt", map_location=device
        )
        print('Loading MobileNetv2 from', path + "/CIFAR10/custom/inception_v3.pt")
